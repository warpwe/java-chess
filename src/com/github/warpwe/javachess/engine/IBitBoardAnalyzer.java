/*
 * BitBoardAnalyzer - A interface for classes, that analyze the position on BitBoards. Copyright (C)
...
/**
 * This interface has to be implemented by any class, that that analyses a BitBoard type chess game
 * position.
 */
public interface IBitBoardAnalyzer {
  ...
  /**
   * A board, where the white king is checkmate.
   */
  short BLACK_HAS_WON = Short.MIN_VALUE;

  /**
   * A board, where the black king is checkmate.
   */
  short WHITE_HAS_WON = Short.MAX_VALUE;
