/*
 * PieceImpl - A class to implement the functionality of a chess piece. Copyright (C) 2003 The
...
package com.github.warpwe.javachess.piece;
...
public class PieceImpl implements IPiece {
   ...
   *
   * @param typeColor
   *          The color and type of piece, with color in bit 0 and the type color in bit 1-3.
   */
