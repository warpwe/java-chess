/*
 * Game - A interface to define the functionality to store a complete game. Copyright (C) 2003 The
...
/**
 * This interface defines the functionality to store a complete game, including access to all the
 * stages of a game.
 */
