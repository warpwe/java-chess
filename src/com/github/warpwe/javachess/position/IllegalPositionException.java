/*
 * IllegalPositionException - A class to indicate a illegal position. Copyright (C) 2003 The
...
/**
 * This exception indicates a illegal position.
 */
public class IllegalPositionException extends IllegalArgumentException {

  // Instance variables
  private static final long serialVersionUID = 4810500010151195657L;
