/*
 * PositionImpl - A class to implement the functionality of the position of one piece of a chess
 * game. Copyright (C) 2003 The Java-Chess team <info@java-chess.de> This program is free software;
