/*
 * EngineStatusListener - The Listener class for all listeners which need to be registered when
 * something in the Engine state changed. Copyright (C) 2003 The Java-Chess team
...
package com.github.warpwe.javachess.listener;
