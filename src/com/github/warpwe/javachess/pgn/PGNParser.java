 ...
 */
public class PGNParser extends antlr.LLkParser implements IPgnTokenTypes {
   ...
   */
  private IGameNotation notation;
  ...
  protected PGNParser(TokenBuffer tokenBuf, int k) {
    super(tokenBuf, k);
    tokenNames = tokenNameStringAraay;
  }
  ...
  public final void pgnGame(IGameNotation notationBuffer) throws RecognitionException,
  ...
  public final void move() throws RecognitionException, TokenStreamException {
    ...
    mI = LT(1);
    match(MOVE_INDEX);
    if (!(++moveIndex == Integer.parseInt(mI.getText())))
                ...
                case PAWN_PROMOTION: {
                  ...
                  if (!(!"P".equals(lc2.getText()) && !"K".equals(lc2.getText())))
                    throw new SemanticException(
                        " ! \"P\".equals( lc2.getText()) && ! \"K\".equals( lc2.getText())");
  ...
  public static final String[] tokenNameStringAraay = {
      "<0>", "EOF", "<2>", "NULL_TREE_LOOKAHEAD", "LBRACK", "RBRACK", "TAG_EVENT",
      "STRING_LITERAL", "TAG_SITE", "TAG_DATE", "TAG_ROUND", "TAG_WHITE", "TAG_BLACK",
      "TAG_RESULT", "TAG_OPENING", "GAME_TERMINATOR", "MOVE_INDEX", "FIGURINE_LETTER_CODE",
      "SQUARE_NAME", "PIECE_MOVE", "PIECE_CAPTURE", "PAWN_PROMOTION", "LEFT_CASTLING",
      "RIGHT_CASTLING", "WS", "DOT", "SL_COMMENT"
  };
