/*
 * AboutDialog - A about box for JavaChess with some info on the project. Copyright (C) 2003 The
...
public class DialogAbout extends JDialog implements ActionListener {
  ...
  /**
   * Get the one and only instance of this class (singleton pattern).
   *
  ...
  private final Reader getDialogResource(String resourceName) {
    ...
    try {
      ...
      // "jar:file:javaChess.jar!/de/java_chess/javaChess/dialogs/resources/" + resourceName);
      URL resourceURL = new URL(
          "file:/Java-Chess-0.1.0pre-alpha3/src/de/java_chess/javaChess/dialogs/resources/"
              + resourceName);
