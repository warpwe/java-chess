/*
 * TransformationDialog - A dialog to determine what type of piece the users wants to get, when a
 * pawn reached the last row. Copyright (C) 2003 The Java-Chess team <info@java-chess.de> This
...
public class TransformationDialog extends JDialog implements ActionListener {
  ...
  // Instance variables
  private static final long serialVersionUID = 1870932136543377871L;
