/*
 * PlayerDialog - The class for editing the players names. Copyright (C) 2003 The Java-Chess team
...
/**
 * <p>
 * Description: Dialog for editing the players names
 * </p>
 * <p>
  ...
  private void jbInit() throws Exception {
    ...
    if (this.iWhite == 1) {
      ...
      this.getContentPane().add(
          jLabel,
          new GridBagConstraints(0, 0, 1, 1, 0.0, 1.0, GridBagConstraints.NORTHWEST,
              GridBagConstraints.NONE, new Insets(2, 2, 2, 2), 0, 0));
      bWhiteOrBlack = true;
    }
    else if (this.iWhite == 2) {
