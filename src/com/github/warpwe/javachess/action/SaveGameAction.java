/*
 * SaveGameAction - A action to save a game. Copyright (C) 2003 The Java-Chess team
...
import com.github.warpwe.javachess.pgn.PGNOutputStream;
...
public class SaveGameAction extends JavaChessAction {
  ...
  // Instance variables
  private static final long serialVersionUID = -3897410132195393514L;
  ...
  public void trySave(File file) {
    try {
      ...
      JOptionPane.showMessageDialog(null, "Error while writing file: " + file.getName(), "Error",
