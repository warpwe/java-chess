/*
 * TransformationPly - A interface to implement a pawn ply to the last row, so it transforms into
 * another piece type. Copyright (C) 2003 The Java-Chess team <info@java-chess.de> This program is
