/*
 * TransformationPlyImpl - A class for pawn plies that reach the last row and transform into a new
 * piece type. Copyright (C) 2003 The Java-Chess team <info@java-chess.de> This program is free
