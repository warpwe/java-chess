/*
 * JavaChess - The main class for the Java chess game. Copyright (C) 2003 The Java-Chess team
...
import com.github.warpwe.javachess.action.AboutAction;
import com.github.warpwe.javachess.action.HelpAction;
import com.github.warpwe.javachess.action.JavaChessAction;
import com.github.warpwe.javachess.action.LoadGameAction;
import com.github.warpwe.javachess.action.ResetGameAction;
import com.github.warpwe.javachess.action.SaveGameAction;
...
import com.github.warpwe.javachess.menu.EditMenu;
...
import com.github.warpwe.javachess.renderer2d.GameTimerPanel;
import com.github.warpwe.javachess.renderer2d.NavigationPanel;
import com.github.warpwe.javachess.renderer2d.NotationPanel;
import com.github.warpwe.javachess.renderer2d.StatusPanel;
import com.github.warpwe.javachess.util.ResourceLoader;
...
public class JavaChess extends JFrame implements IEngineStatusListener {
   ...
   * 
   */
  private static final long serialVersionUID = -3623258173543281540L;
  ...
  /**
   * glassPane zum Reagieren auf Mausbewegungen etc.: The glass pane overlays the menu bar and
   * content pane, so it can intercept mouse movements and such.
   */
  private JComponent glasspane = new JComponent() {
    private static final long serialVersionUID = 8380815389362595495L;
  ...
  private void jbInit() throws Exception {
    ...
    ResourceLoader.getInstance().addLocation(
        "jar:file:javaChess.jar!/de/java_chess/javaChess/renderer2d/images/");
    ...
    this._exitItem.setAccelerator(javax.swing.KeyStroke.getKeyStroke(88,
    ...
    contentPane.add(_gameTimer, new GridBagConstraints(1, 1, 1, 1, 1.0, 0.0,
        GridBagConstraints.NORTH, GridBagConstraints.NONE, new Insets(2, 2, 2, 2), 0, 0)); // The
                                                                                           // Clock
    ...
    contentPane.add(jpStatus, new GridBagConstraints(0, 3, 2, 1, 1.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0)); // Statuszeile
    ...
    contentPane.add(jpNavigation, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0,
        GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0)); // Notation
                                                                                            // etc.

    jpBrett.add((ChessBoardRenderer2D) _renderer, new GridBagConstraints(0, 0, 1, 1, 1.0, 1.0,
        GridBagConstraints.NORTHWEST, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
    jpBrett.setBorder(BorderFactory.createBevelBorder(BevelBorder.LOWERED, Color.white,
  ...
  /**
   * If Java-Chess is closed over the 'X' and not via File-Exit, a process would be still running
   *
   * @param e
   *          The Window event
   */
