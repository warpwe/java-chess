/*
 * StatusPanel - The class for the status panel in the main window. Copyright (C) 2003 The
...
public class StatusPanel extends JPanel {
   ...
   * The generated ID.
   */
  private static final long serialVersionUID = 127854022132047290L;
  ...
  private void jbInit() throws Exception {
    ...
    add(jlAction, new GridBagConstraints(0, 0, 1, 1, 0.6, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
    add(jlStatus, new GridBagConstraints(1, 0, 1, 1, 0.2, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
    add(jlVersion, new GridBagConstraints(2, 0, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
        GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
