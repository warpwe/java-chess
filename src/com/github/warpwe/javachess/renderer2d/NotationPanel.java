/*
 * NotationPanel - A panel to display the game notation. Copyright (C) 2003 The Java-Chess team
...
public class NotationPanel extends JPanel implements ActionListener {
   ...
   * The generated ID.
   */
  private static final long serialVersionUID = 3942283997562684780L;

  /**
   * The notation object.
   */
  IGameNotation gameNotation;
  ...
  private void jbInit() throws Exception {
    ...
    this.add(jlHeadline, new GridBagConstraints(0, 0, 1, 1, 1.0, 0.0, GridBagConstraints.NORTHWEST,
        GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    this.add(jpPlayers, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
        GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

    jpPlayers.add(jlWhite, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 4));
    jpPlayers.add(jbWhite, new GridBagConstraints(1, 0, 1, 1, 1.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.HORIZONTAL, new Insets(0, 5, 0, 5), 0, 0));
    jpPlayers.add(jlBlack, new GridBagConstraints(2, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.NONE, new Insets(0, 5, 0, 0), 0, 0));
    jpPlayers.add(jbBlack, new GridBagConstraints(3, 0, 1, 1, 1.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.HORIZONTAL, new Insets(0, 5, 0, 5), 0, 0));
  ...
  public void setWhitePlayerName(String newName) {
    ...
    if (gameNotation != null) {
      gameNotation.setPlayerInfo(newName, true);
    }
  }
  ...
  public void setBlackPlayerName(String newName) {
    ...
    // If there's a notation object, pass the new name to it.
    if (gameNotation != null) {
      gameNotation.setPlayerInfo(newName, false);
    }
  }
