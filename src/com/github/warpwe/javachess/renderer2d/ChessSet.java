/*
 * ChessSet - A class to provide a image of a set of chess pieces. Copyright (C) 2002,2003 Andreas
...
public class ChessSet extends BufferedImage {
  ...
  public ChessSet(Component c) {
    ...
    // im = Toolkit.getDefaultToolkit().getImage( new URL(
    // "jar:file:javaChess.jar!/de/java_chess/javaChess/renderer2d/images/ChessPieces02.gif"));
    // im = ResourceLoader.getInstance().loadImage(
    // "file:///C:/Dokumente und Einstellungen/Wilfried/Eigene Dateien/Java-Chess-0.1.0pre-alpha3/src/de/java_chess/javaChess/renderer2d/images/ChessPieces02.gif");
