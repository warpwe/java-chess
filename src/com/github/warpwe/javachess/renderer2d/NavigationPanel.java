/*
 * NavigationPanel - The class for the game navigation. Copyright (C) 2003 The Java-Chess team
...
public class NavigationPanel extends JPanel implements ActionListener {
   ...
   * The generated ID.
   */
  private static final long serialVersionUID = 2661610683322186290L;
  ...
  /**
   * The button for one ply (=half move) forward
   */
  ...
  private void jbInit() throws Exception {
    ...
    // jbBack.setIcon( new ImageIcon( Toolkit.getDefaultToolkit().getImage( new URL(
    // "jar:file:javaChess.jar!/de/java_chess/javaChess/renderer2d/images/back02.gif"))));
    // jbStart.setIcon( new ImageIcon( Toolkit.getDefaultToolkit().getImage( new URL(
    // "jar:file:javaChess.jar!/de/java_chess/javaChess/renderer2d/images/start02.gif"))));
    // jbForward.setIcon( new ImageIcon( Toolkit.getDefaultToolkit().getImage( new URL(
    // "jar:file:javaChess.jar!/de/java_chess/javaChess/renderer2d/images/forward02.gif"))));
    // jbEnd.setIcon( new ImageIcon( Toolkit.getDefaultToolkit().getImage( new URL(
    // "jar:file:javaChess.jar!/de/java_chess/javaChess/renderer2d/images/end02.gif"))));
    ...
    this.add(jbStart, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
        GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    this.add(jbBack, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
        GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    this.add(jbForward, new GridBagConstraints(2, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
        GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    this.add(jbEnd, new GridBagConstraints(3, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
        GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
  ...
  private void moveOnePlyBack() {
    ...
    System.out.println("Einen Halbzug zurueck");
  }
