/*
 * PositionRenderer - A class to render chessboard squares. Copyright (C) 2003 The Java-Chess team
...
/**
 * This class renders a position on the chessboard, no matter if it is empty or a piece on the
 * square.
 */
class PositionRenderer extends JLabel {
   ...
   * The generated ID.
   */
  private static final long serialVersionUID = -2876535359727512559L;
  ...
  /**
   * Create a new position rendering with a given image of a piece. image The image for the
   * rendering.
   */
  ...
  /**
   * Move a piece from another position to this one. positionRenderer The position renderer for the
   * source.
   */
