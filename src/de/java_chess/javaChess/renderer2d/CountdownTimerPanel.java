...
public class CountdownTimerPanel extends JPanel implements Runnable {
     ...
     * The timer thread.
     */
    public volatile Thread _timerThread;
	...
	for( Iterator<ActionListener> iterator = _actionListeners.iterator(); iterator.hasNext(); ) {
     ...
     */
    public void display( long _time) {
	...
	int timeSec = (int)( _time / 1000L);  // Display accurate to  1 s.
